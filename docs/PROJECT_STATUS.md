...
Spec version: 1.4
Repository revision: M02-W06 corrective implementation in progress over 3d8b18ccc86109a2b6a3bb3cc3ae6d16f5ced9f9 / tree 383fdd61fbebc61ec346734b02a7dba62af1e8b2
Last updated: 2026-08-10T17:10:11-04:00
...
- Correction verification: W06 passes 163/163 across six files (corpus-freeze 20, coverage-policy 28, holdout-boundary 44, artifact-preimage correction 38, historical mutation campaign exactly 15, version/log/runner 18). The correction suite covers all 30 mandated cases plus role/ancestor path collisions, hidden-case honesty, v1 runtime preservation, public-schema preservation, and broad-root rejection; a separate corpus regression directly rejects both mapping versions from the public directory. The historical mutants are unchanged. W05 remains 290, W04 171, W01 108, W02 57, fixtures 166, mock ATS 32, Playwright 59, contracts 2440 / focused 662 / generated 183 byte-identical, canonical Python 977, and Rust 1+10. Local `pnpm verify` exits 0 with all 16 ACTIVE suites PASS, status 45 groups, traceability 193/300, and visual NOT_YET_APPLICABLE. Exact-SHA three-OS hosted evidence remains pending the forward-only content push; no genuine owner root was used.
