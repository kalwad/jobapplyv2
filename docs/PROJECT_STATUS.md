...
Spec version: 1.4
Repository revision: M02-W08 application-root correction in progress from required implementation commit b7b7a157aa10e8f2dd0b9f15a06c46e7327b33c3 / tree 732a4d2241d267dc4c579f4622d3cd1991e98c84
Last updated: 2026-08-22T11:46:39-04:00
...
- State: M02-W08 (implement semantic field identity and per-frame scanner) is IN_PROGRESS. The narrow application-root correction writer began from the required clean synchronized implementation commit `b7b7a157aa10e8f2dd0b9f15a06c46e7327b33c3` / tree `732a4d2241d267dc4c579f4622d3cd1991e98c84`, whose parent is the required governance commit `2131c3395f042aef9ebb7df4456f9b9fd3230ba4`. No package is READY, M02 remains IN_PROGRESS, and M00 and M01 remain ACCEPTED. M02-W07 remains VERIFIED, not ACCEPTED, at exact independently cleared content commit `ce74ef49e142bb7c2cab608cd0c800d312bd2217` / tree `9412c5b71437ee562534a1fb92e80ab50ffc333d` after verdict `SOL_CLEAR_FINAL_M02_W07_NINTH_CORRECTION_CONTENT` and exact-SHA hosted run `32522233170`.
- Application-root correction: the fresh W08 verifier stopped because one qualifying native form nested in semantic `main` was widened to that ancestor and admitted unrelated sibling controls. The correction returns the unique native or `role=form` candidate itself after no stronger explicit application root wins; explicit-root precedence, no-form semantic-main fallback, and multi-form ambiguity remain unchanged. Six finite bundled-Chromium regressions lock those boundaries. Visibility semantics and every W09/W10/W11 surface remain untouched; fresh independent W08 verification is still required.
