...
Spec version: 1.4
Repository revision: M02-W05 proleptic-UTC correction in progress over corrected content commit fdf7bdaa0488179bff1d0aa9d78e7c1787d25090 / tree 554bdc075967a2667cc37379465f06e931af1b21 (parent 383ae578512910b17d98aee30e1f24531fa746c8)
Last updated: 2026-08-09T23:55:00-04:00
...
- State: M02-W05 (build evaluation runner) is IN_PROGRESS and unaccepted; the fresh independent Fable 5 acceptance verification returned `FABLE_BLOCKED_M02_W05_GOVERNANCE` (2026-08-09) against exact corrected content commit `fdf7bdaa0488179bff1d0aa9d78e7c1787d25090` / tree `554bdc075967a2667cc37379465f06e931af1b21`, and an owner-selected Fable 5 Ultra Code corrective writer pass is closing the one acceptance blocker (KI-0053, low-year UTC projection) plus the secondary NON_PRODUCTION test-governance dilution (KI-0054) from that exact content; no package is READY. That fresh verification independently closed the five KI-0048 through KI-0052 defect classes and explicitly accepted the documented leap-table-free leap-second projection. M02-W04 remains VERIFIED, not ACCEPTED, at exact content commit `5ed2768c895bc2ce3c236d089745556c7e563d5f` / tree `656c61d87d0615b6a9b96319888856057686223b` after the independent `SOL_CLEAR_FOR_FINAL_M02_W04_GOVERNANCE` audit. M02-W01, M02-W02, and M02-W03 remain VERIFIED at their preserved trees; M02 and M02-W05 remain IN_PROGRESS; M00 and M01 remain ACCEPTED.
- Defect history: M02-W05 implementation `383ae578512910b17d98aee30e1f24531fa746c8` received `SOL_BLOCKED_M02_W05_GOVERNANCE` (2026-08-08) for five acceptance defects recorded as KI-0048 through KI-0052; the first corrective pass produced `fdf7bdaa0488179bff1d0aa9d78e7c1787d25090`, whose fresh independent Fable 5 verification returned `FABLE_BLOCKED_M02_W05_GOVERNANCE` (2026-08-09): the five earlier defect classes were independently closed and the leap-second projection review passed, but a new acceptance blocker was found — the low-year Date.UTC projection (KI-0053, HIGH: the contract-valid year-zero 36-hour window `0000-02-29T00:00:00Z -> 0000-03-01T12:00:00Z` was accepted as 43200000 ms, bypassing the 86400000 ms boundary, and the contract-valid 1000 ms `0099 -> 0100` window was spuriously rejected) — plus a secondary W05-caused dilution of the M02-W01 NON_PRODUCTION fixture-consumer assertion (KI-0054, MEDIUM). Both were reproduced on the exact corrected content before this second correction and remain IN_PROGRESS pending a separate fresh independent verification, as do KI-0048 through KI-0052 until that fresh session verifies the complete corrected revision. Prior M02-W04 history: `7fcdfa34797c29289737f558a7826cd12fb42fc0` received `SOL_BLOCKED_M02_W04_GOVERNANCE`; first correction `a5aa43602e67a66c5319fa7b24aa8b6b32bfd71f` received `SOL_BLOCKED_CORRECTED_M02_W04_GOVERNANCE`; second correction `5ed2768c895bc2ce3c236d089745556c7e563d5f` received the final clear verdict. All blocked reports remain reproduction targets rather than acceptance evidence. KI-0046 and KI-0047 remain FIXED with their complete history preserved in docs/KNOWN_ISSUES.md.
...
- Local implementation proof: the second corrective pass replaces the Date-based numeric calendar projection in `src/time.ts` with deterministic proleptic-Gregorian integer arithmetic over the whole 0000–9999 contract year domain (canonical contract validation first, positive day-ordinal counting from year zero, BigInt combination, Number conversion only after a proven safe-integer bound), preserving the accepted leap-table-free Unix-style leap-second projection and deterministic fractional truncation byte-identically; restores the exact M02-W01 NON_PRODUCTION fixture-consumer assertion for both reviewed consumers while keeping W05's legitimate second consumer; declares the runner manifest EVALUATION_ONLY/NON_PRODUCTION with no version, dependency, or lockfile change; adds a static governance ban on `Date.UTC`/`Date.parse` in runner source; and refreshes the REQ-GATE-006 completed code/test anchors (`src/derive.ts`, `src/time.ts`, and the three correction regression test files) through the canonical reviewed traceability hash transition `e2075f70… -> 89db8aaa…` with the package dependency hash unchanged. The evaluation-runner suite passes 290/290 tests across 12 files (31 new permanent low-year/leap-second regressions in `measurement-boundaries.test.ts`, including literal reviewed epoch anchors, an independent iterative reference over the complete 0000–9999 domain, calendar-boundary durations, the end-to-end 36-hour year-zero rejection, replay-equality and witness-mutation proofs, and the 23:59:60Z next-minute-boundary control); the historical finite mutation campaign remains exactly 18/18 with its original classes untouched, and all earlier replay-source, regression-source, FAILED_SETUP, UTC, and limitation regressions remain green. Both fresh-verifier reproductions were executed on the exact corrected `fdf7bda` content before editing (36-hour window accepted as 43200000 ms and replayed/rendered; 0099->0100 spuriously rejected) and their corrected behaviors re-executed on the new content (36-hour window rejects `RUNNER_CLOCK_DURATION` from its true 129600000 ms duration; 0099->0100 derives exactly 1000 ms and replays). W04 remains 171/171; W01 108/108 with the restored NON_PRODUCTION assertion; W02 57/57; fixtures 166/166; mock lab 32/32; Playwright 59/59 across 17 files; scripts tests remain at their preserved inventory with no Python test added; status, traceability (193/300 after the reviewed hash transition), and generated contracts (183 byte-identical) remain enforced by the full local canonical verifier with every ACTIVE suite passing and visual truthfully NOT_YET_APPLICABLE. Exact-SHA hosted proof is recorded after the correction push, without changing package state.
- Preserved prerequisite hosted proof: W04 push run `31225740045` remains successful at exact SHA `5ed2768c895bc2ce3c236d089745556c7e563d5f`, and the first W05 correction run `31332138602` remains successful at exact SHA `fdf7bdaa0488179bff1d0aa9d78e7c1787d25090` (jobs 93291966430 ubuntu-24.04, 93291966414 macos-15, 93291966361 windows-2025). The second-correction exact-SHA hosted verification follows its content push and does not constitute independent acceptance verification or governance closeout.
...
- Blockers: KI-0053 (HIGH) and KI-0054 (MEDIUM) are IN_PROGRESS from the fresh independent `FABLE_BLOCKED_M02_W05_GOVERNANCE` verification of `fdf7bda`; their corrections are implemented in this second writer pass with permanent regression coverage. KI-0048, KI-0049, KI-0050, and KI-0051 (HIGH) and KI-0052 (MEDIUM) remain IN_PROGRESS from the earlier `SOL_BLOCKED_M02_W05_GOVERNANCE` review — the fresh verifier independently closed those five defect classes, but they close only when a separate fresh independent session verifies the complete corrected W05 revision. KI-0046 and KI-0047 remain FIXED by the verified M02-W04 content and independent acceptance evidence. KI-0022, KI-0026, and KI-0027 remain DEFERRED with their named future owners; all previously fixed issues remain fixed and no earlier package is reopened beyond restoring the one M02-W01 governance assertion W05 itself weakened.
...
| `M02-W05` | IN_PROGRESS | — | — | Build evaluation runner; blocked by `FABLE_BLOCKED_M02_W05_GOVERNANCE` at `fdf7bda` (earlier `SOL_BLOCKED_M02_W05_GOVERNANCE` at `383ae57`), second corrective writer pass in progress and unaccepted |
...
- KI-0048 (HIGH, IN_PROGRESS) — Report replay lacked authoritative source binding; corrected in the M02-W05 writer pass and independently closed as a defect class by the fresh Fable verification, awaiting fresh verification of the complete corrected revision
- KI-0049 (HIGH, IN_PROGRESS) — Serialized regression comparisons lacked authenticated candidate/reference compatibility; corrected in the M02-W05 writer pass and independently closed as a defect class by the fresh Fable verification, awaiting fresh verification of the complete corrected revision
- KI-0050 (HIGH, IN_PROGRESS) — FAILED_SETUP admitted paired measurement statistics; corrected in the M02-W05 writer pass and independently closed as a defect class by the fresh Fable verification, awaiting fresh verification of the complete corrected revision
- KI-0051 (HIGH, IN_PROGRESS) — Execution records admitted nonexistent UTC calendar dates; corrected in the M02-W05 writer pass and independently closed as a defect class by the fresh Fable verification, awaiting fresh verification of the complete corrected revision
- KI-0053 (HIGH, IN_PROGRESS) — Low-year UTC projection violated canonical proleptic-Gregorian time; corrected in the second M02-W05 writer pass, awaiting separate fresh independent verification
