...
Spec version: 1.4
Repository revision: M02-W06 v1 runtime-preservation corrective implementation in progress over 4bf08f8ddf8bd4452d6a7575fc3fd04f22540084 / tree ff63971ac29e0b187c582d1d4df822a70aa4f7e7
Last updated: 2026-08-11T15:09:17-04:00
Current phase: A — Contract, measurement, and early autofill proof
Current milestone: M02
Current work package: M02-W06
...
- State: M02-W06 (freeze v1 corpus and holdout manifest) is IN_PROGRESS and unaccepted. M02-W05 remains VERIFIED, not ACCEPTED, at exact content commit `b27b192aa18c86da180badc43b5f32efe96d88ab` / tree `40bbe111a4f80702c1fdd98b576534f1284873fc`; M02-W01 through M02-W04 also remain VERIFIED at their preserved trees. M02-W07 remains NOT_STARTED, no package is READY, M02 remains IN_PROGRESS, and M00 and M01 remain ACCEPTED.
- Owner-review blocker: the fresh independent owner-controlled review of content `3d8b18ccc86109a2b6a3bb3cc3ae6d16f5ced9f9` / tree `383fdd61fbebc61ec346734b02a7dba62af1e8b2` returned `OWNER_HOLDOUT_REVIEW_BLOCKED` with exact reason `INPUT_ARTIFACT_PREIMAGE_UNAVAILABLE`: 11/11 hidden cases in the rejected owner draft declared input-artifact commitments whose preimage bytes were absent from the v1 executable inventory. No hidden value or case was disclosed, the reviewer made no repository mutation, and the failed draft remains external and untouched. KI-0055 is HIGH / IN_PROGRESS.
- Runtime-preservation blocker: fresh independent Sol verification of exact content `4bf08f8ddf8bd4452d6a7575fc3fd04f22540084` / tree `ff63971ac29e0b187c582d1d4df822a70aa4f7e7` returned `SOL_BLOCKED_M02_W06_ARTIFACT_PREIMAGE_CORRECTION` for A16: the mapping-v2 exact-ID predicate had also narrowed historical `validateOwnerMappingV1` runtime semantics across manifest, case, file, creation-source, and review-source IDs. Before stopping on A16, that verifier independently reproduced the historical KI-0055 defect and found the mapping-v2 architecture coherent; its clean synthetic 3-case / 2-container / 3-preimage control, case/artifact/preimage binding, closed inventory, filesystem controls, BigInt identity, Windows root relation, sanitized export, exported-manifest source-authority refusal, and safe diagnostics all passed. Those partial checks are reproduction evidence only, not final KI-0055 acceptance. KI-0056 is MEDIUM / IN_PROGRESS pending fresh independent verification of the narrow v1 runtime-preservation correction.
...
- Correction verification: the complete W06 command set passed twice and was byte-neutral both times: 194/194 across six files (corpus-freeze 20, coverage-policy 28, holdout-boundary 44, artifact-preimage/runtime-preservation correction 69, historical mutation campaign exactly 15, version/log/runner 18). The 31 new differential tests preserve literal historical v1 runtime semantics across all five roles and whole mappings, document the already-stricter unchanged v1 schema, keep a v1-only root non-executable, and prove strict v2 runtime/schema agreement across all six v2 roles including artifact. The KI-0055 artifact-preimage suite, public-manifest non-leak controls, BigInt identity, and Windows cross-volume semantics remain green; the historical mutants are unchanged. W05 remains 290, W04 171, W01 108, W02 57, fixtures 166, mock ATS 32, Playwright 59, contracts 2440 / focused 662 / generated 183 byte-identical, scripts Python 976 and canonical Python inventory 977, and Rust 1+10. After the exact W06 discovery expectation was narrowly updated from 163 to 194, full `pnpm verify` exited 0 with 3,300 TypeScript tests, all 16 ACTIVE suites PASS, status 45 groups, traceability 193/300, and visual NOT_YET_APPLICABLE. Exact-SHA three-OS hosted evidence remains pending the forward-only content push; no genuine owner root was used.
...
- Scope: private `@japp/evaluation-corpus` remains EVALUATION_ONLY / NON_PRODUCTION with gate authority NONE. Public corpus v1 and public `benchmark/holdout-manifest:v1` bytes/contracts remain unchanged. The corrected private boundary uses `mapping.v2.json` to inventory case containers and opaque artifact preimages, recomputes every declared artifact digest from exact bytes, and returns a private v2 receipt with separate counts and byte totals. Historical mapping-v1 runtime IDs are preserved through their literal historical grammar, but the v1 schema stays byte-identical and a v1-only owner root remains refused as final evidence; mapping v2, artifact refs, provenance, and sanitized-manifest validation remain strict. No genuine sanitized owner manifest is available, no placeholder is fabricated, and no hidden body, artifact body, expected output, path, or owner draft is committed. W07, W13, W14, and W15 have not begun; no real provider/model/network dependency or critical-gate mutation exists. `model/model-lock.json`, `prompts/registry.yaml`, generated benchmark contracts, public corpus truth, and all four critical-gate reports remain untouched. REQ-GATE-002, REQ-GATE-006, REQ-GATE-010, and REQ-GATE-011 remain SCAFFOLD_ONLY / NOT_YET_APPLICABLE; all four critical gates remain NOT_EVALUATED and release remains NOT_READY.
- Blockers: KI-0055 is the live HIGH / IN_PROGRESS M02-W06 blocker. `OWNER_HOLDOUT_MANIFEST_REQUIRED` also remains the explicit unresolved owner handoff dependency: a fresh author must rebuild only after independent acceptance of the correction. KI-0046 through KI-0054 remain FIXED; KI-0022, KI-0026, and KI-0027 remain DEFERRED with their named future owners; no earlier package is reopened.
...
| `M02-W06` | IN_PROGRESS | — | — | Freeze v1 corpus and holdout manifest; content implementation underway and unaccepted |
...
- ID: NONE
- Reason: M02-W06 is IN_PROGRESS and unaccepted. M02-W07 remains NOT_STARTED and has not begun; no package is READY.
- Required reading: NONE until M02-W06 receives fresh independent verification and governance closeout.

## Known release blockers

- KI-0055 (HIGH, IN_PROGRESS) — M02-W06 owner holdout verification lacked input-artifact preimage binding
