 ...
 * Closed token set; undeclared tokens are rejected.
 */
export type ErrorTaxonomyV1ErrorFamily = "VALIDATION" | "CONFLICT" | "UNSUPPORTED" | "SENSITIVE" | "MODEL" | "STORAGE" | "TRANSPORT" | "RENDERING" | "SITE" | "BENCHMARK" | "GATE" | "SUBMISSION";
 ...
 * Closed token set; undeclared tokens are rejected.
 */
export type ErrorTaxonomyV1ErrorOrigin = "DESKTOP_APP" | "EXTENSION_CONTENT_SCRIPT" | "EXTENSION_SERVICE_WORKER" | "NATIVE_HOST" | "ORCHESTRATOR" | "MODEL_RUNTIME" | "PLATFORM_ADAPTER" | "PUBLIC_JOB_INDEX" | "VERIFICATION_HARNESS";
 ...
 * Closed token set; undeclared tokens are rejected.
 */
export type ErrorTaxonomyV1ErrorSeverity = "WARNING" | "ERROR" | "CRITICAL";
 ...
 *
 * Pattern: ^error\.[a-z]+\.[a-z0-9]+(?:_[a-z0-9]+)*$
 * Maximum length: 96.
 */
export type ErrorTaxonomyV1MessageKey = string;
 ...
 * Closed token set; undeclared tokens are rejected.
 */
export type ErrorTaxonomyV1RetryDisposition = "SAFE_RETRY" | "RETRY_AFTER_REMEDIATION" | "PAUSE_FOR_USER" | "NO_RETRY_PROHIBITED" | "NO_RETRY_TERMINAL";
 ...
 * Maximum length: 200.
 */
export type ErrorTaxonomyV1UserSafeMessage = string;
