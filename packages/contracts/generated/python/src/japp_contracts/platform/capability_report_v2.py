...
Source of truth: packages/contracts/schemas/platform/capability-report.v2.schema.json
Schema id: urn:japp:schema:platform:capability-report:v2
...
class PlatformCapabilityReportV2(ContractModel):
