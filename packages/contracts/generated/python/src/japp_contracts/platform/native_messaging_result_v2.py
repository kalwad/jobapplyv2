...
Source of truth: packages/contracts/schemas/platform/native-messaging-result.v2.schema.json
Schema id: urn:japp:schema:platform:native-messaging-result:v2
...
class PlatformNativeMessagingResultV2(ContractModel):
