...
Source of truth: packages/contracts/schemas/platform/evidence-record.v2.schema.json
Schema id: urn:japp:schema:platform:evidence-record:v2
...
class PlatformEvidenceRecordV2(ContractModel):
