...
Source of truth: packages/contracts/schemas/platform/diagnostic-report.v1.schema.json
Schema id: urn:japp:schema:platform:diagnostic-report:v1
...
class PlatformDiagnosticReportV1(ContractModel):
