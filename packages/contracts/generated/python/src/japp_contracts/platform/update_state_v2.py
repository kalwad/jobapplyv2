...
Source of truth: packages/contracts/schemas/platform/update-state.v2.schema.json
Schema id: urn:japp:schema:platform:update-state:v2
...
class PlatformUpdateStateV2(ContractModel):
