...
SemanticRuleCatalogV1RuleKind = Literal["APPLICATION_SESSION_CONSISTENCY", "ATOMIC_CLAIM_INTEGRITY", "ATS_VARIANT_SCOPE", "BENCHMARK_CASE_INTEGRITY", "BENCHMARK_RESULT_INTEGRITY", "DRIVER_VERIFIED_EVIDENCE", "FIELD_ADDRESS_IDENTITY", "FIELD_DECISION_AUTHORITY", "FIELD_DESCRIPTOR_OBSERVATION", "GATE_DECISION_INTEGRITY", "GATE_EVIDENCE_COMPLETENESS", "GUIDED_RUN_SAFETY", "HOLDOUT_MANIFEST_INTEGRITY", "INERT_TEXT_SAFETY", "LAYOUT_MEASUREMENT_INTEGRITY", "NAVIGATION_SAFETY", "PAGE_READINESS_INTEGRITY", "PLATFORM_BROWSER_DISCOVERY_SAFETY", "PLATFORM_BROWSER_RECORD_SCOPE", "PLATFORM_BROWSER_RECORD_SCOPE_V2", "PLATFORM_CAPABILITY_REPORT_INTEGRITY", "PLATFORM_CAPABILITY_REPORT_INTEGRITY_V2", "PLATFORM_CERTIFICATION_INPUT_SCOPE", "PLATFORM_CERTIFICATION_INPUT_SCOPE_V2", "PLATFORM_DIAGNOSTIC_INTEGRITY", "PLATFORM_DIAGNOSTIC_INTEGRITY_V2", "PLATFORM_EVIDENCE_INTEGRITY", "PLATFORM_EVIDENCE_INTEGRITY_V2", "PLATFORM_MODEL_PROFILE_EVIDENCE", "PLATFORM_MODEL_PROFILE_EVIDENCE_V2", "PLATFORM_NATIVE_REGISTRATION_BINDING", "PLATFORM_NATIVE_REGISTRATION_BINDING_V2", "PLATFORM_NATIVE_REGISTRATION_RESULT", "PLATFORM_NATIVE_REGISTRATION_RESULT_V2", "PLATFORM_PACKAGE_STATE_EVIDENCE", "PLATFORM_PACKAGE_STATE_EVIDENCE_V2", "PLATFORM_PATH_REQUEST_SAFETY", "PLATFORM_PATH_RESOLUTION_SAFETY", "PLATFORM_PATH_RESOLUTION_SAFETY_V2", "PLATFORM_PROCESS_PLAN_SAFETY", "PLATFORM_PROCESS_PLAN_SAFETY_V2", "PLATFORM_PROCESS_STATUS_INTEGRITY", "PLATFORM_PROCESS_STATUS_INTEGRITY_V2", "PLATFORM_RUNTIME_CAPABILITY_FALLBACK", "PLATFORM_RUNTIME_CAPABILITY_FALLBACK_V2", "PLATFORM_SECRET_REQUEST_AUTHORITY", "PLATFORM_SECRET_RESULT_INTEGRITY", "PLATFORM_SECRET_RESULT_INTEGRITY_V2", "PLATFORM_TARGET_SUPPORT_CLAIM", "RECONCILIATION_READINESS", "RESUME_PLAN_EVIDENCE", "WORKDAY_CERTIFICATION_SCOPE", "WORKDAY_STEP_BOUNDARY", "WORKDAY_TENANT_IDENTITY"]
