# services/job-ingestion-worker

Late-stage permitted-source job collectors (docs/MASTER_IMPLEMENTATION_SPEC.md
§5.1): official ATS job APIs, permitted public career pages, and optional
